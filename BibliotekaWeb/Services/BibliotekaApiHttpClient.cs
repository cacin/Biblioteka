...
namespace BibliotekaWeb.HttpClients
{
    ...
    public partial class BibliotekaApiHttpClient
    {
        ...
        public async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Historia>> ApiHistoriaGetAsync(int id, System.Threading.CancellationToken cancellationToken)
        {
            ...
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/Historia/{id}");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200")
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<Historia>>(response_, headers_).ConfigureAwait(false);
                        ...
                        return default(System.Collections.Generic.ICollection<Historia>);
                    }
                    finally
                    {
                        if (response_ != null)
        ...
        public async System.Threading.Tasks.Task ApiHistoriaPostAsync(int id, System.DateTimeOffset dataOd, string osoba, System.Threading.CancellationToken cancellationToken)
        {
            ...
            if (dataOd == null)
                throw new System.ArgumentNullException("dataOd");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/Historia/{id}, {dataOd}, {osoba}");
            urlBuilder_.Replace("{id}", System.Uri.EscapeDataString(ConvertToString(id, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{dataOd}", System.Uri.EscapeDataString(dataOd.ToString("s", System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{osoba}", System.Uri.EscapeDataString(ConvertToString(osoba, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        public async System.Threading.Tasks.Task ApiHistoriaPutAsync(int id, System.DateTimeOffset dataDo, System.Threading.CancellationToken cancellationToken)
        {
            ...
            if (dataDo == null)
                throw new System.ArgumentNullException("dataDo");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/Historia/{id}, {dataDo}");
            urlBuilder_.Replace("{id}", System.Uri.EscapeDataString(ConvertToString(id, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{dataDo}", System.Uri.EscapeDataString(dataDo.ToString("s", System.Globalization.CultureInfo.InvariantCulture)));
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "201")
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<Pozycja>(response_, headers_).ConfigureAwait(false);
                            return objectResponse_.Object;
                        }
                        else
                        if (status_ != "200" && status_ != "204")
        ...
        public async System.Threading.Tasks.Task<Pozycja> ApiPozycjeGetAsync(int id, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/Pozycje/{id}");
            urlBuilder_.Replace("{id}", System.Uri.EscapeDataString(ConvertToString(id, System.Globalization.CultureInfo.InvariantCulture)));
    ...
    {
        [Newtonsoft.Json.JsonProperty("pozycjaId", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int PozycjaId { get; set; }

        [Newtonsoft.Json.JsonProperty("tytul", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        public string Tytul { get; set; }

        [Newtonsoft.Json.JsonProperty("autor", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        ...
        [Newtonsoft.Json.JsonProperty("uzytkownik", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    {
        [Newtonsoft.Json.JsonProperty("hisoriaID", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int HisoriaID { get; set; }

        [Newtonsoft.Json.JsonProperty("dataOd", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [Newtonsoft.Json.JsonProperty("pozycja", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
